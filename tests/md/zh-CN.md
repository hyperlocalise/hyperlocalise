...
在使用 [状态参考](https://example.com/docs/status?tab=cli#dry-run) 之前提交更改。

参考链接也应该保留：[CLI 指南][cli-guide]和 ![图表](https://example.com/assets/flow(chart).png)。
...
- 父项
  - 嵌套笔记包含 [故障排除](https://example.com/docs/troubleshooting#common-errors) 和 `{{locale}}`
