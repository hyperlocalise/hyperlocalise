...
Crowdin and record organization glossary concordance responses for five query
cases per target language.
...
response for each of the 20 concordance calls. By default it is written to
