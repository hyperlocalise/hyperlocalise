...
description: Search the live web each day for competitor, market, and localisation changes, then post a sourced brief to Slack.
category: popular
activatable: true
---
...
Goal:
- Deliver a daily, source-backed research brief the team can act on.
