...
export const PRODUCT_USAGE_ANALYTICS_EVENTS = {
  ...
  contentEditorSegmentApproved: "cat_segment_approved",
  contentEditorSegmentDraftSaved: "cat_segment_draft_saved",
  contentEditorCommentCreated: "cat_comment_created",
  contentEditorAiRecommendationRequested: "cat_ai_recommendation_requested",
