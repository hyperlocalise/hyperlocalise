...
describe("NativeContentEditorCommentService.save", () => {
  it("saves comments only and rejects issue type", async () => {
    ...
    const service = new NativeContentEditorCommentService(db, projectTranslationService);
...
describe("NativeContentEditorCommentService legacy issue comments", () => {
