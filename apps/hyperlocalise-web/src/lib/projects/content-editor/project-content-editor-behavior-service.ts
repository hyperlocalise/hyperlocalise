...
export async function updateProjectContentEditorGroupingPolicy(input: {
  organizationId: string;
  projectId: string;
  ...
  const [project] = await database
    ...
    .set({
      ...
      contentEditorGroupingRevision: sql`${schema.projects.contentEditorGroupingRevision} + 1`,
    ...
    .returning({
      ...
      groupingRevision: schema.projects.contentEditorGroupingRevision,
    });
