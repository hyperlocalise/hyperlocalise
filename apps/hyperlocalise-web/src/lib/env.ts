...
export const env = createEnv({
  ...
  server: {
    ...
    /**
     * Optional Vercel Container Registry image for Sandbox.create (e.g.
     * `hyperlocalise-sandbox:latest`). When set, replaces the default `node26`
     * runtime. Built from apps/sandbox-image.
     */
