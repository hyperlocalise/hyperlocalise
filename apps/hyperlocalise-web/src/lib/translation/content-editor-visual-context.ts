 ...
 */
export type ContentEditorVisualContextMarker = {
  left: number;
  top: number;
  width: number;
  height: number;
...
export type ContentEditorVisualContextScreenshot = {
  id: string;
  name: string | null;
  imageUrl: string;
  width: number | null;
  height: number | null;
  markers: ContentEditorVisualContextMarker[];
};

export type ContentEditorVisualContext = {
  screenshots: ContentEditorVisualContextScreenshot[];
};
...
export function pixelRectToPercentMarkers(input: {
  ...
  widthPx: number;
  heightPx: number;
}): ContentEditorVisualContextMarker | null {
