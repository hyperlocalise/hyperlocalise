...
import { loadContentEditorSegmentVisualContext } from "./content-editor-core";

describe("loadContentEditorSegmentVisualContext", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it("dispatches Phrase visual context with token, region, and external identifiers", async () => {
    ...
    await loadContentEditorSegmentVisualContext({
      organizationId: "org_1",
      providerKind: "phrase",
      externalProjectId: "project_1",
      externalStringId: "string_1",
