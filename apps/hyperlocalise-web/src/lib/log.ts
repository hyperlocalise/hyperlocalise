...
export const REDACTION_PATHS = [
  ...
  "x-secret",
  "*.x-secret",
  '["x-hyperlocalise-webhook-secret"]',
  '*.["x-hyperlocalise-webhook-secret"]',
  "x-hyperlocalise-webhook-secret",
  "*.x-hyperlocalise-webhook-secret",
  '["x-hyperlocalise-signature-256"]',
  '*.["x-hyperlocalise-signature-256"]',
  "x-hyperlocalise-signature-256",
  "*.x-hyperlocalise-signature-256",
  ...
  "x-provider-signature-256",
  "*.x-provider-signature-256",
  'headers["x-phraseapp-signature"]',
  "headers.x-phraseapp-signature",
  'headers["event-signature"]',
  "headers.event-signature",
  'headers["x-secret"]',
  "headers.x-secret",
  'headers["x-hyperlocalise-webhook-secret"]',
  "headers.x-hyperlocalise-webhook-secret",
  'headers["x-hyperlocalise-signature-256"]',
  "headers.x-hyperlocalise-signature-256",
  'headers["x-provider-signature-256"]',
  "headers.x-provider-signature-256",
];
