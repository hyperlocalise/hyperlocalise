...
type ProviderContentEditorFile = {
  provider?: {
    kind?: string;
...
type ProviderContentEditorResourceSupport = {
  file: boolean;
  key: boolean;
};
...
const providerCatResourceSupportByKind: Record<
  ...
  ProviderContentEditorResourceSupport
> = {
...
export function supportsProviderContentEditorFile(file: ProviderContentEditorFile): boolean {
