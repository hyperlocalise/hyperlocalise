...
import { buildFigmaSourcePath, parseTranslationFile, segmentsToTranslationFile } from "./segment-file";
import type { FigmaDesignSegment, FigmaLocalizationStatus, StartFigmaLocalizationResult } from "./types";
