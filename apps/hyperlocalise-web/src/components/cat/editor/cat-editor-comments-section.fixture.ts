 ...
 */
import type { CatSegment, CatSegmentComment } from "@/components/cat/shared/types";

export const catEditorCommentsSegmentId = "11111111-1111-4111-8111-111111111111";

export const catEditorCommentsFixture: CatSegmentComment[] = [
  {
    id: "comment-note-1",
    type: "comment",
    status: null,
...
export function createCatEditorCommentsSegment(
  overrides: Partial<CatSegment> & { comments?: CatSegmentComment[] } = {},
): CatSegment {
  return {
    id: catEditorCommentsSegmentId,
    index: 2,
    key: "0Flpdy",
    sourceText: "Social:",
    targetText: "ソーシャル：",
