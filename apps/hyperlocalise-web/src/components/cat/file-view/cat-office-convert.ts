...
} from "@/components/cat/file-view/cat-office-mime";

export type CatOfficeKind = "docx" | "xlsx" | "pptx";

export type CatOfficeSnapshot =
...
export function emptyOfficeSnapshot(kind: CatOfficeKind, title: string): CatOfficeSnapshot {
  switch (kind) {
    case "docx":
