...
// Brand names for SVG icon titles (proper nouns; not translated)
const PROVIDER_ICON_TITLE = {
  chatgpt: "OpenAI",
  claude: "Claude",
  cursor: "Cursor",
  github: "GitHub",
...
const providers = {
  chatgpt: {
    ...
    icon: (
      <svg fill="currentColor" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <title>{PROVIDER_ICON_TITLE.chatgpt}</title>
  ...
  claude: {
    ...
    icon: (
      <svg fill="currentColor" role="img" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
        <title>{PROVIDER_ICON_TITLE.claude}</title>
        <path
          clipRule="evenodd"
  ...
  cursor: {
    ...
    icon: (
      <svg version="1.1" viewBox="0 0 466.73 532.09" xmlns="http://www.w3.org/2000/svg">
        <title>{PROVIDER_ICON_TITLE.cursor}</title>
        <path
  ...
  github: {
    ...
    icon: (
      <svg fill="currentColor" role="img" viewBox="0 0 24 24">
        <title>{PROVIDER_ICON_TITLE.github}</title>
  ...
  scira: {
    ...
    icon: (
      ...
      >
        <title>{PROVIDER_ICON_TITLE.scira}</title>
        <path
  ...
  v0: {
    ...
    icon: (
      <svg fill="currentColor" viewBox="0 0 147 70" xmlns="http://www.w3.org/2000/svg">
        <title>{PROVIDER_ICON_TITLE.v0}</title>
