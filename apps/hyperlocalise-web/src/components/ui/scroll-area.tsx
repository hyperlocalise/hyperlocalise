  ...
  return (
    <ScrollAreaPrimitive.Scrollbar
      ...
      className={cn(
        ...
        orientation === "horizontal" && "h-2.5 flex-col border-t border-t-transparent px-1 pe-1.25",
  ...
  return (
    <>
      ...
      <div
        ...
        className={cn(
          "pointer-events-none absolute inset-0 z-10",
          "before:absolute before:inset-y-0 before:start-0 before:transition-[width,opacity] before:duration-300 before:content-['']",
          "after:absolute after:inset-y-0 after:end-0 after:transition-[width,opacity] after:duration-300 after:content-['']",
