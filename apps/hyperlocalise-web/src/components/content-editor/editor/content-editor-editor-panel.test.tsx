...
import type { ContentEditorEditorPanelProps } from "@/components/content-editor/editor/content-editor-editor-panel.types";

import { ContentEditorEditorPanel } from "./content-editor-editor-panel";

function renderEditorPanel(overrides: Partial<ContentEditorEditorPanelProps> = {}) {
  ...
  const props: ContentEditorEditorPanelProps = {
    segment,
    segmentPosition: 2,
  ...
  return {
    props,
    ...renderWithContentEditorProviders(<ContentEditorEditorPanel {...props} />),
  };
}

describe("ContentEditorEditorPanel UI", () => {
