...
} from "./content-editor-message-token-styles";

describe("contentEditorMessageTokenToneClass", () => {
  it("uses readable foreground tokens for ICU highlights in both themes", () => {
    const classes = contentEditorMessageTokenToneClass("icu").split(" ");
  ...
  it("uses readable foreground tokens for placeholder highlights in both themes", () => {
    const classes = contentEditorMessageTokenToneClass("placeholder").split(" ");
  ...
  it("uses readable foreground tokens for pound highlights in both themes", () => {
    const classes = contentEditorMessageTokenToneClass("pound").split(" ");
  ...
  it("styles tag highlights with semantic border and foreground tokens", () => {
    const classes = contentEditorMessageTokenToneClass("tag").split(" ");
  ...
  it("styles error highlights with rounded corners and theme-aware flame tokens", () => {
    const classes = contentEditorMessageTokenToneClass("error").split(" ");
...
describe("contentEditorMessageTokenMissingClass", () => {
  it("uses readable foreground tokens for missing ICU tokens", () => {
    const classes = contentEditorMessageTokenMissingClass.split(" ");
