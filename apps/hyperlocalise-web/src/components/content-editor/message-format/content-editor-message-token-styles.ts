 ...
 */
export type ContentEditorMessageTokenVisualKind =
  | "icu"
  | "placeholder"
  | "pound"
  | "tag"
...
export function contentEditorMessageTokenToneClass(kind: ContentEditorMessageTokenVisualKind) {
  switch (kind) {
    case "icu":
...
export const contentEditorMessageTokenMissingClass =
