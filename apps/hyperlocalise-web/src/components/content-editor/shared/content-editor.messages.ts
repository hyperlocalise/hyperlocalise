...
export const contentEditorWorkspaceMessages = defineMessages({
  emptyQueue: {
...
export const contentEditorQueuePanelMessages = defineMessages({
  queueTitle: {
    defaultMessage: "Queue",
    id: "EUZbcVhX5v",
...
export const contentEditorSegmentStatusMessages = defineMessages({
  pending: {
    defaultMessage: "Untranslated",
    id: "pmgrWye2G2",
...
export const contentEditorHiddenStringMessages = defineMessages({
  hidden: {
    defaultMessage: "Hidden",
    id: "/d/gbp0E4g",
...
export const contentEditorLockedStringMessages = defineMessages({
  locked: {
...
export const contentEditorGlossaryChecksMessages = defineMessages({
  complianceLabel: {
...
export const contentEditorFormatChecksMessages = defineMessages({
  emptyChecks: {
...
export const contentEditorTargetEditorMessages = defineMessages({
  icuStructure: {
...
export const contentEditorIntelligencePanelMessages = defineMessages({
  panelTitle: {
...
export const contentEditorEditorPanelMessages = defineMessages({
  previousSegmentAria: {
...
export const contentEditorPanelErrorBoundaryMessages = defineMessages({
  queuePanelTitle: {
