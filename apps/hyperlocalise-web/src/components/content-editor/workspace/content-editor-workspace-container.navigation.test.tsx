...
describe("ContentEditorWorkspaceContainer queue navigation", () => {
  ...
  it("removes filtered-out queue rows when the server snapshot refreshes", async () => {
    ...
    const filteredState = createContentEditorWorkspaceState({
...
describe("ContentEditorWorkspaceContainer side-by-side approve", () => {
  beforeEach(() => {
