...
export function ContentEditorComfortableResizableLayout({
  ...
  return (
    ...
    >
      ...
      >
        <ContentEditorResizablePane>{queue}</ContentEditorResizablePane>
      </ResizablePanel>
      <ResizableHandle
        withHandle
        aria-label={intl.formatMessage(contentEditorWorkspaceViewMessages.resizeQueuePanel)}
      />
      <ResizablePanel
        id="editor"
        ...
        className="min-h-0 min-w-0 overflow-hidden"
      >
        <ContentEditorResizablePane>{editor}</ContentEditorResizablePane>
      </ResizablePanel>
      <ResizableHandle
        withHandle
        aria-label={intl.formatMessage(contentEditorWorkspaceViewMessages.resizeIntelligencePanel)}
      />
      <ResizablePanel
        id="intelligence"
