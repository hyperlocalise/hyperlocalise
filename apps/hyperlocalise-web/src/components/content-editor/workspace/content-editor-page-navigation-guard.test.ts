...
} from "./content-editor-page-navigation-guard";
...
describe("attemptCatPageNavigation", () => {
  ...
  it("delegates to the registered guard", () => {
    ...
    const guardRef = { current: guard } satisfies ContentEditorPageNavigationGuardRef;
  ...
  it("blocks proceed when the guard does not call it", () => {
    ...
    const guardRef = {
      current: () => {},
    } satisfies ContentEditorPageNavigationGuardRef;
