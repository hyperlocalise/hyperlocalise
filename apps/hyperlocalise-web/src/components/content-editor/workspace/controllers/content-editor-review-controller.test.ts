...
import { ContentEditorReviewController } from "./content-editor-review-controller";
...
function createController(
  ...
  ports: Partial<ConstructorParameters<typeof ContentEditorReviewController>[1]> = {},
) {
...
describe("ContentEditorReviewController", () => {
