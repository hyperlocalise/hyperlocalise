...
import {
  createVisualEditorFixture,
  visualEditorFixture,
} from "./content-editor-visual-editor.fixture";
import { ContentEditorVisualEditorWorkspace } from "./content-editor-visual-editor-workspace";

const meta = {
  title: "CAT/Visual Editor",
  component: ContentEditorVisualEditorWorkspace,
  parameters: {
    layout: "fullscreen",
  },
  decorators: [
...
} satisfies Meta<typeof ContentEditorVisualEditorWorkspace>;
