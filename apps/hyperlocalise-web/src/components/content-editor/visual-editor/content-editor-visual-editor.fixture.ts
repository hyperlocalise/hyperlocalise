...
import type {
  ...
  ContentEditorVisualEditorProgress,
...
export type {
  ...
  ContentEditorVisualEditorFilePage,
  ContentEditorVisualEditorFixture,
  ContentEditorVisualEditorNodeMeta,
  ContentEditorVisualEditorPreviewKind,
  ContentEditorVisualEditorProgress,
  ContentEditorVisualEditorSegment,
} from "./content-editor-visual-editor.types";
...
function createSegment(
  input: Omit<ContentEditorVisualEditorSegment, "sourceLocale" | "targetLocale" | "index"> & {
    index: number;
  },
): ContentEditorVisualEditorSegment {
  return {
...
function buildIntelligenceForSegments(
  ...
  primary: { segmentId: string; intelligence: ContentEditorSegmentIntelligence },
): Record<string, ContentEditorSegmentIntelligence> {
  return {
    ...
    ...Object.fromEntries(
      segments
        ...
        .map((segment) => [
          ...
          } satisfies ContentEditorSegmentIntelligence,
        ]),
    ),
  };
}

export const visualEditorHomeSegmentsFixture: ContentEditorVisualEditorSegment[] = [
  createSegment({
...
export const visualEditorPricingSegmentsFixture: ContentEditorVisualEditorSegment[] = [
  createSegment({
...
export const visualEditorHeroIntelligenceFixture: ContentEditorSegmentIntelligence = {
...
export const visualEditorPricingIntelligenceFixture: ContentEditorSegmentIntelligence = {
...
function createFilePage(input: {
  ...
  primaryIntelligence: ContentEditorSegmentIntelligence;
}): ContentEditorVisualEditorFilePage {
  return {
...
export const visualEditorPagesBySourcePath: Record<string, ContentEditorVisualEditorFilePage> = {
...
export function createVisualEditorFixture(
  overrides: Partial<ContentEditorVisualEditorFixture> = {},
): ContentEditorVisualEditorFixture {
  return {
