...
import type {
  ...
  ContentEditorRiskLevel,
  ContentEditorSegmentStatus,
} from "@/components/content-editor/shared/types";

export type ContentEditorTone = "safe" | "watch" | "risk" | "info";

export function contentEditorToneClass(tone: ContentEditorTone) {
  switch (tone) {
    case "safe":
...
export function segmentStatusTone(status: ContentEditorSegmentStatus): ContentEditorTone {
  switch (status) {
    case "reviewed":
      return "safe";
    case "needs_review":
...
export function segmentStatusLabel(status: ContentEditorSegmentStatus) {
  switch (status) {
    case "reviewed":
      return "Reviewed";
    case "needs_review":
...
export function riskLevelTone(level: ContentEditorRiskLevel): ContentEditorTone {
  switch (level) {
    case "good":
    case "low":
      return "safe";
...
export function formatCheckTone(status: ContentEditorFormatCheckStatus): ContentEditorTone {
  switch (status) {
    case "pass":
      return "safe";
    case "warn":
...
export function glossaryTermStatusClass(
  term: ContentEditorGlossaryTerm,
  forbiddenInTarget: boolean,
) {
