...
export type ContentEditorSegmentTagKind = "type" | "comment" | "issue";

export function getSegmentTagKind(tag: string): ContentEditorSegmentTagKind {
...
function segmentTagClassName(kind: ContentEditorSegmentTagKind) {
  switch (kind) {
    case "issue":
...
export function ContentEditorSegmentTags({ tags }: { tags: string[] }) {
  if (tags.length === 0) {
    return null;
  }
