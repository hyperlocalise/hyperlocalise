...
export function PrinciplesSection() {
  return (
    <section id="overview">
      ...
      <div className="mt-10 overflow-hidden rounded-[1.5rem] border border-foreground/10 bg-background shadow-[0_20px_48px_rgba(0,0,0,0.22)] sm:mt-12 sm:rounded-[2rem] sm:shadow-[0_32px_80px_rgba(0,0,0,0.28)]">
        <div className="grid divide-y divide-foreground/10 lg:grid-cols-3 lg:divide-x lg:divide-y-0">
              ...
              >
                <div className="space-y-8 sm:space-y-12 lg:space-y-16">
                  ...
                  <div className="max-w-none space-y-4 sm:max-w-[21ch]">
                    ...
                    <TypographyP className="max-w-none text-pretty text-[0.95rem] leading-[1.75] text-foreground/50 sm:max-w-[30ch] sm:text-[1rem] sm:leading-7">
                      {item.description}
                    </TypographyP>
                  </div>
                </div>

                <div className="flex items-center gap-6 text-foreground/42">
                  <a
                    href={href}
                    className="inline-flex items-center gap-2 text-[1rem] tracking-[-0.02em] transition-colors duration-300 hover:text-foreground/72 sm:text-[1.05rem]"
                  >
