  ...
  return [
    ...
    },
    {
      ...
      features: [
        ...
        intl.formatMessage({
          defaultMessage: "20 AI Tokens ($20 of AI credit)",
          id: "YmNdzcKFnD",
          description: "Starter plan feature: included AI Token allowance",
        }),
      ],
      cta: { label: comingSoon, kind: "coming_soon" },
    },
    {
      ...
      features: [
        ...
        intl.formatMessage({
          defaultMessage: "2,000 AI Tokens ($2,000 of AI credit)",
          id: "JlV+Ndt4ky",
          description: "Growth plan feature: included AI Token allowance",
        }),
      ],
      cta: { label: comingSoon, kind: "coming_soon" },
    },
      ...
      rows: [
        ...
        },
        {
          ...
          label: intl.formatMessage({
            ...
            id: "tfqQU/Qg+U",
            description: "Pricing matrix row label for included AI Tokens",
          }),
          detail: intl.formatMessage({
            defaultMessage:
              "Each AI Token is $1 of managed AI credit. Model usage draws down your balance at published rates.",
            id: "gGQlq/uYwx",
            description: "Pricing matrix detail explaining AI Token dollar credit",
          }),
          cells: {
            free: { kind: "dash" },
            starter: { kind: "text", value: "20 ($20)" },
            growth: { kind: "text", value: "2,000 ($2,000)" },
            enterprise: { kind: "text", value: custom },
          },
        },
        {
