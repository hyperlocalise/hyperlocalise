...
export const projectFileCatActivityLogsQuerySchema = z.object({
...
export type ProjectFileContentEditorActivityLogsQuery = z.infer<
  typeof projectFileCatActivityLogsQuerySchema
>;
