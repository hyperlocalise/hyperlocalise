...
const Logo = () => {
  return (
    <Link href="#" className="flex items-center space-x-2">
      <Image src="/images/logo.png" className="size-8 dark:invert" width={32} height={32} alt="hyperlocalise logo" />
      <span className="text-2xl font-bold">Hyperlocalise</span>
    </Link>
  );
};
      ...
      <header className="border-b px-4 md:px-6">
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Popover>
              <PopoverTrigger
                render={<Button className="group size-8 md:hidden" variant="ghost" size="icon" />}
              >
                <svg
          ...
          {/* Right side */}
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="sm" className="text-sm" render={<a href="#" />}>
              Sign In
            </Button>
            <Button size="sm" className="text-sm" render={<a href="#" />}>
              Get Started
            </Button>
          </div>
        </div>
