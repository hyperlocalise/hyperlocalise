...
export const alt = "Hyperlocalise Localisation Audit";
export const size = marketingOgImageSize;
export const contentType = marketingOgImageContentType;

type LocalisationAuditOgImageProps = {
  params: Promise<{ lang: string }>;
};

export default async function Image({ params }: LocalisationAuditOgImageProps) {
