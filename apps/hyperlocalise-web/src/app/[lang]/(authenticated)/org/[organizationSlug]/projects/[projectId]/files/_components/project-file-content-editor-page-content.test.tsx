...
describe("ProjectFileContentEditorPageContent CAT shell", () => {
  beforeEach(() => {
  ...
  it("passes a saved repository preference into the CAT workspace", async () => {
    localStorage.setItem("job-content-editor-repository:acme:proj_1:en-US.json", "acme/docs");
  ...
  it("prompts for a repository when multiple GitHub repos are enabled and none is selected", async () => {
    ...
    expect(screen.getByTestId("content-editor-workspace")).toHaveAttribute("data-repo", "");
  });
