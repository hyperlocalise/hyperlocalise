...
export const dashboardOverviewFixture: WorkspaceOverviewSnapshot = {
  ...
  activity: [
    {
      id: "job_failed_sync",
      kind: "job",
      title: { kind: "sync", direction: "push", connectorKind: "github" },
      projectName: "Help center",
      jobKind: "sync",
      jobType: null,
      status: "failed",
    ...
    },
    {
      id: "job_review_fr",
      kind: "job",
      title: { kind: "review", criteria: "terminology consistency" },
      projectName: "Website localization",
      jobKind: "review",
      jobType: null,
      status: "waiting_for_review",
    ...
    },
    {
      id: "job_translate_home",
      kind: "job",
      title: { kind: "text", text: "marketing/home.json" },
      projectName: "Website localization",
      jobKind: "translation",
      jobType: "file",
      status: "running",
    ...
    },
    {
      id: "run_001",
      kind: "automation",
      title: { kind: "text", text: automationsFixture[0]!.name },
      projectName: null,
      jobKind: null,
      jobType: null,
      status: "succeeded",
  ...
  projects: dashboardProjectsFixture.slice(0, 2).map((project) => ({
    id: project.id,
    name: project.name,
    ...
    domain: null,
    localeRoute: formatDashboardLocaleRoute(project.sourceLocale, project.targetLocales),
    latestJobTitle: { kind: "review" as const, criteria: "terminology consistency" },
