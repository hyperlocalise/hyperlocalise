...
import { resolveDefaultJobContentEditorQueueFilter } from "@/lib/projects/job-content-editor-routing";
      ...
      <ProviderLiveJobDetailView
        ...
        renderFilesSection={({
          ...
          <TmsLiveJobFilesSection
            ...
            queueFilter={resolveDefaultJobContentEditorQueueFilter(job)}
          />
        )}
      />
