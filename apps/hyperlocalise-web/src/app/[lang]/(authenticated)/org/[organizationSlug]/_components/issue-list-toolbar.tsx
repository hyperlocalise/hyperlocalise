    ...
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Popover>
          ...
          <PopoverContent align="end" className="w-[22rem] gap-3 p-3 sm:w-[26rem]">
        ...
        <div className="flex items-center gap-1.5">
          <Select
            ...
            onValueChange={(value) =>
              onStateChange({
                sort: (value ?? "status") as IssueListUrlState["sort"],
              })
            }
          >
            <SelectTrigger
          ...
          <Select
            ...
            onValueChange={(value) =>
              onStateChange({
                sortDir: (value ?? "asc") as IssueListUrlState["sortDir"],
              })
            }
          >
            <SelectTrigger
...
/** @deprecated Use IssueListToolbar */
export const IssueListFiltersBar = IssueListToolbar;
