...
export const projectOverviewJobsFixture: ApiJob[] = [
  {
    ...
    completedAt: null,
    workflowRunId: null,
    lastError: "Translation provider timeout",
  ...
  },
  {
    ...
    lastError: null,
    inputPayload: {
      sourceFileId: "marketing/pricing.json",
      metadata: { title: "Pricing page update" },
    },
    outcomeKind: null,
    outcomePayload: null,
    reviewCriteria: null,
  ...
  },
  {
    ...
    workflowRunId: null,
    lastError: null,
    inputPayload: { metadata: { title: "Checkout flow strings" } },
    outcomeKind: null,
    outcomePayload: null,
