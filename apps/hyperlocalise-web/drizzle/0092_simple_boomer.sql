...
--> statement-breakpoint
DROP TABLE "canva_connections" CASCADE;--> statement-breakpoint
...
CREATE INDEX "idx_canva_brand_org_bindings_org" ON "canva_brand_org_bindings" USING btree ("organization_id");--> statement-breakpoint
...
CREATE INDEX "idx_canva_oauth_sessions_expires_at" ON "canva_oauth_sessions" USING btree ("expires_at");