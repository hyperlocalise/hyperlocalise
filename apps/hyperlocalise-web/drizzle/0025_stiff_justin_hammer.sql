...
CREATE UNIQUE INDEX "provider_sync_intents_lease_key_active_key" ON "provider_sync_intents" USING btree ("lease_key") WHERE "provider_sync_intents"."status" in ('pending', 'running', 'retryable');