...
CREATE UNIQUE INDEX "project_cat_string_overlays_lookup" ON "project_cat_string_overlays" USING btree ("organization_id","project_id","source_path","external_resource_id","external_string_id");--> statement-breakpoint
CREATE INDEX "idx_project_cat_string_overlays_file" ON "project_cat_string_overlays" USING btree ("organization_id","project_id","source_path","external_resource_id");