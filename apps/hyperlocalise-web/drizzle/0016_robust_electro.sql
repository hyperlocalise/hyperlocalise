...
CREATE TYPE "public"."glossary_sync_state" AS ENUM('synced', 'stale', 'syncing', 'error');--> statement-breakpoint
CREATE TYPE "public"."glossary_term_provenance" AS ENUM('manual', 'sync');--> statement-breakpoint
...
ALTER TABLE "glossaries" ADD COLUMN "sync_state" "glossary_sync_state";--> statement-breakpoint
...
ALTER TABLE "glossary_terms" ADD COLUMN "provenance" "glossary_term_provenance" DEFAULT 'manual' NOT NULL;--> statement-breakpoint
