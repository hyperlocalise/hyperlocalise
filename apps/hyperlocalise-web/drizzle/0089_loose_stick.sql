...
ALTER TABLE "glossary_terms" ADD COLUMN "external_user_id" text;--> statement-breakpoint
ALTER TABLE "glossary_terms" ADD COLUMN "external_created_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "glossary_terms" ADD COLUMN "external_updated_at" timestamp with time zone;--> statement-breakpoint
CREATE UNIQUE INDEX "glossary_concepts_glossary_external_key" ON "glossary_concepts" USING btree ("glossary_id","external_key");