/* eslint-disable formatjs/no-literal-string-in-jsx -- placeholder template; use @canva/app-i18n-kit for production */
...
export const App = () => {
    ...
    return (
        <div className={styles.scrollContainer}>
            <Rows spacing="2u">
                <Text>
                    This example demonstrates how apps can translate all text in
                    the current page. Translation is simulated with lorem ipsum
                    placeholder text.
                </Text>
                <Button
                    variant="secondary"
