...
For pull request drift and integrity checks without hand-rolling CLI steps, use the [GitHub Action drift check](/cli/workflows/github-action-drift-check) composite action instead.
...
- [Validate translations in pull requests](/cli/workflows/github-action-drift-check).
