...
Upload a small file through Cloud or [CLI sync push](/platform/cli), then confirm the matching run and translation output. Make the scope narrower if the task should cover only selected content.
