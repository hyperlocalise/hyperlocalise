...
Open a file from **Files** to enter the Content Editor, or use **Content Editor** in the project sidebar when the project supports an all-files queue. See [Content Editor](/platform/cat).
...
Choose the tutorial that matches the source files in your repository.

<CardGroup cols={3}>
  <Card title="GitHub workflow" icon="github" href="/platform/tutorials/github-localisation-workflow">
    Automate source upload and translation pull requests.
  </Card>
  <Card title="React Intl" icon="code" href="/platform/tutorials/react-intl-icu">
    Extract and review FormatJS and ICU messages.
  </Card>
  <Card title="Vue" icon="layer-group" href="/platform/tutorials/vue-i18n">
    Sync vue-i18n JSON catalogs and review target locales.
  </Card>
  <Card title="iOS Strings" icon="mobile" href="/platform/tutorials/ios-strings">
    Localise Swift apps with .strings files.
  </Card>
  <Card title="Android" icon="mobile-screen" href="/platform/tutorials/android-string-resources">
    Localise strings.xml and plural resources.
  </Card>
  <Card title="Gettext" icon="server" href="/platform/tutorials/gettext-pot-po">
    Connect POT extraction to reviewed PO catalogs.
  </Card>
  <Card title="XLIFF" icon="file-code" href="/platform/tutorials/xliff">
    Sync XLIFF interchange files by locale.
  </Card>
</CardGroup>
