...
Native workspace **translation memories** support interchange through Platform. External TMS memories follow different rules when they are not mirrored locally.
...
| Asset | Platform export | Platform import |
| ----- | ------------ | ------------ |
